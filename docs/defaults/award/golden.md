...
??? abstract "Variable Lists (click to expand)"
    ...
    * **Shared Template Variables** are additional variables shared across the PMM Defaults.
    ...
    === "File-Specific Template Variables"
        ...
        | `use_best_picture`                 | **Description:** Turn the Best Picture collections off.<br>**Values:** `false` to turn of the collections       
        
        | `use_best_director`                 | **Description:** Turn the Best Director collections off.<br>**Values:** `false` to turn of the collections                                                                                                                                                                                                                                                                                                                                                                                                                          |
